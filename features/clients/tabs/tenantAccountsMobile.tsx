    ...
    return (
      <div className="flex justify-center items-center p-8">
        <div className="text-center">
          <p className="mb-4 text-red-600">{accountsResponse?.message || "Failed to load accounts"}</p>
    ...
    <div className="space-y-6">
      ...
      {accounts.length === 0 ? (
        <div className="flex flex-col justify-center items-center py-16">
          ...
          <Button onClick={() => setIsAddModalOpen(true)} className="shadow-sm bg-primary hover:bg-primary/90">
            <Plus className="mr-2 w-4 h-4" />
                ...
                <div className="relative p-6 pb-4">
                  <div className="flex justify-between items-start mb-4">
                    <div className="flex gap-3 items-center">
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="font-semibold truncate text-card-foreground">{account.account_name}</h3>
                  ...
                  <div className="mb-4">
                    ...
                    <div className="px-4 py-3 rounded-lg border bg-muted/50 border-border">
                      <p className="font-mono text-lg font-semibold text-card-foreground">{account.account_number}</p>
                    </div>
                  </div>
                  ...
                  {account.bank_name && (
                    <div className="mb-4">
                      <p className="mb-2 text-xs font-medium tracking-wide uppercase text-muted-foreground">Provider</p>
