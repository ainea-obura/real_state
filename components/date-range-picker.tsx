...
export const DateRangePicker: FC<DateRangePickerProps> & {
  ...
  const setPreset = (preset: string): void => {
    ...
    // Don't call onUpdate immediately for presets - wait for Apply
  };
  ...
  const resetToOpenedValues = (): void => {
      ...
      <PopoverContent align={align} className="w-auto">
        <div className="flex py-2">
                  ...
                  <div className="flex gap-2">
                    <DateInput
                      ...
                      onChange={(date) => {
                        ...
                        // Don't call onUpdate - wait for Apply
                      }}
                    />
          ...
          {!isSmallScreen && (
            <div className="flex flex-col items-end gap-1 pr-2 pb-6 pl-6">
              <div className="flex flex-col items-end gap-1 pr-2 pb-6 pl-6 w-full">
                {PRESETS.map((preset) => (
                  <PresetButton
                    key={preset.name}
                    preset={preset.name}
        ...
        <div className="flex justify-end gap-2 py-2 pr-4">
          ...
          <Button
            onClick={() => {
              setIsOpen(false);
              // Only call onUpdate when Apply is clicked
