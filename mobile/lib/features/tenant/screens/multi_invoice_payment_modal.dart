...
class MultiInvoicePaymentModal extends StatefulWidget {
  final List<Invoice> selectedInvoices;
  final double totalAmount;

  const MultiInvoicePaymentModal({
    super.key,
  ...
  @override
  State<MultiInvoicePaymentModal> createState() =>
      _MultiInvoicePaymentModalState();
}

class _MultiInvoicePaymentModalState extends State<MultiInvoicePaymentModal> {
