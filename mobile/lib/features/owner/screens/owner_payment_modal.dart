...
class OwnerPaymentModal extends StatefulWidget {
  final Invoice invoice;

  const OwnerPaymentModal({super.key, required this.invoice});

  @override
  State<OwnerPaymentModal> createState() => _OwnerPaymentModalState();
}

class _OwnerPaymentModalState extends State<OwnerPaymentModal> {
  ...
  Future<void> _submitPayment() async {
    ...
    try {
      ...
      final paymentData = {
        'recipientType': 'owner', // Owner payments
      ...
      if (kDebugMode) {
        ...
        print(
          'Recipient Type: ${paymentData['recipientType']} (Owner payments)',
        );
  ...
  Future<void> _cancelPayment() async {
    // Always close the modal when cancel is pressed
    Get.back();
